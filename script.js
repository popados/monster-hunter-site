...
text_plate = this.document.getElementById("monster-names")

for (i = 0; i <= DATA.length; i++) {
    index++
    // mob = this.document.createElement("name")
    monster_data.push(DATA[i])
    console.log(DATA[i])
...
for (let index = 0; index < monster_data.length; index++) {
    ...
    console.log(monster_data[index].name)
    monster_names.push(monster_data[index].name)
    
}

let name_plate = this.document.getElementById("monster-names")

for (let index = 0; index < monster_names.length; index++) {
    // const element = array[index];
    // const element = array[index];
    console.log(monster_names[index])
    document.write("<li>")
    document.write(monster_names[index])
    document.write("<br>")
}
console.log(monster_names)
